...
> v2：新增「纯原生自动注册」与「图标路径回退」（从 BaseLib 提炼，零第三方依赖）
## 概述
...
> 从 BaseLib 提炼，零第三方依赖。能力不进池，用 `[PowerModel]` 标记 + ContentRegistry 统一 `ModelDb.Inject`。
...
BaseLib 会做 `ResourceLoader.Exists()` 回退，纯原生一行即可：

```csharp
public override string CustomPackedIconPath =>
    ResourceLoader.Exists("res://MyMod/images/powers/my_power.png")
        ? "res://MyMod/images/powers/my_power.png"
        : "res://MyMod/images/powers/fallback.png";
```
