...
> 更多 `Modify*`/`After*` 钩子见 [relic-callbacks.md](../relic/relic-callbacks.md)（生命周期钩子表）或 [power-callbacks.md](../power/power-callbacks.md)（Modify 回调表），或直接 `grep Modify Core/Models/AbstractModel.cs`。
